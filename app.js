(() => {
  ...
  const ROLE_NAV_IDS = Object.freeze({
    ...
    system_admin:["dashboard","operations","students","history","teachers","headteachers","academics","timetable","prospectus","delegations","reports","certificates","id_cards","insights","users","notifications","compliance","audit","backup_restore","license_capacity","settings"],
